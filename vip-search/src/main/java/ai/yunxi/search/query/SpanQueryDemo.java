...
public class SpanQueryDemo {
    public static void createIndex() throws IOException {
        // 索引存放路径
        Directory directory = FSDirectory.open(Paths.get("D:/Lucene/span"));
    ...
    public static void main(String[] args) throws IOException {
        // SpanQueryDemo.createIndex();
        SpanQueryDemo.spanNearQuery();
        SpanQueryDemo.spanNotQuery();
        SpanQueryDemo.spanOrQuery();
    }
}
