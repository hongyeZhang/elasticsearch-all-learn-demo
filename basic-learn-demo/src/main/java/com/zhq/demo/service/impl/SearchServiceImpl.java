...
public class SearchServiceImpl implements SearchService {
    ...
    public void initEs() {
        restClient = new RestHighLevelClient(
                        RestClient.builder(new HttpHost("192.168.41.129", 9200, "http"),
    ...
    public void buildSearchRequest() {
         ...
         * 聚合请求的使用
         */
        TermsAggregationBuilder aggregation = AggregationBuilders.terms("by_company").field(
                        "company.keyword");
    ...
    private void processSearchResponse(SearchResponse searchResponse) {
        ...
        log.info("status is " + status + ";took is " + took + ";terminatedEarly is "
                        + terminatedEarly + ";timedOut is " + timedOut);
        ...
        for (SearchHit hit : searchHits) {
            ...
            log.info("sourceAsString is " + sourceAsString + ";sourceAsMap size is " + sourceAsMap
                            .size());
