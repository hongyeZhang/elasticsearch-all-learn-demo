...
public class MeetElasticSearchServiceImpl implements MeetElasticSearchService {
    ...
    @PostConstruct
    public void initEs() {
        restClient = RestClient.builder(new HttpHost("192.168.41.129", 9200, "http"), new HttpHost("192"
                                        + ".168"
                                        + ".41.129",
                                        9201,
                                        "http"))
    ...
    public void initEsWithHeader() {
        RestClientBuilder builder = RestClient.builder(new HttpHost("192.168.41.129", 9200, "http"));
    ...
    public void setThreadNumber(int number) {
        RestClientBuilder builder = RestClient.builder(new HttpHost("192.168.41.129", 9200))
    ...
    public void setSniffer() {
        RestClient restClient =
                        RestClient.builder(new HttpHost("192.168.41.129", 9200, "http")).build();
    ...
    public void setSnifferWhenFail(int failTime) {
        ...
        RestClient restClient = RestClient.builder(new HttpHost("192.168.41.129", 9200))
