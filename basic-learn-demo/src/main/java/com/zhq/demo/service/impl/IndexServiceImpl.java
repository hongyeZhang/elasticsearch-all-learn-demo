package com.zhq.demo.service.impl;

import com.zhq.demo.service.IndexService;
...
public class IndexServiceImpl implements IndexService {
    ...
    public void executeClearIndicesCacheRequest(String index) {
        ...
        try {
            ClearIndicesCacheResponse clearCacheResponse = restClient.indices().clearCache(request, RequestOptions.DEFAULT);
    ...
    public void executeForceMergeRequest(String index) {
        ...
        try {
            ForceMergeResponse forceMergeResponse = restClient.indices().forcemerge(request, RequestOptions.DEFAULT);
    ...
    public void executeRolloverRequest(String index) {
        ...
        try {
            RolloverResponse rolloverResponse = restClient.indices().rollover(request, RequestOptions.DEFAULT);
    ...
    public IndicesAliasesRequest buildIndicatesAliasesRequest(String index, String indexAlias) {
        ...
        AliasActions aliasAction = new AliasActions(AliasActions.Type.ADD).index(index).alias(indexAlias);
    ...
    public void executeIndicatesAliasesRequest(String index, String indexAlias) {
        ...
        try {
            AcknowledgedResponse indicesAliasesResponse = restClient.indices().updateAliases(request, RequestOptions.DEFAULT);
